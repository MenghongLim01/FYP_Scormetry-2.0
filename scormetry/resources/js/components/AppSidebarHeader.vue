        ...
        <div class="flex w-full items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
                <Button
                    variant="ghost"
                    size="icon"
                    class="h-9 w-9 rounded-full border border-border bg-background hover:bg-accent dark:border-sidebar-border/60 dark:bg-sidebar-accent/40 dark:hover:bg-sidebar-accent"
                >
                    <Bell class="size-4 opacity-80" />
                </Button>
