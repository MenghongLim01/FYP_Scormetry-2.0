            ...
            <div v-if="isTeacherOrAdmin" class="flex flex-wrap gap-2">
                <Button variant="outline" size="sm" as-child>
                    <Link :href="rubricEdit.url(rubric.id)">
                        ...
                        {{ rubric.status === 'locked' ? 'Correct Locked Rubric' : 'Edit Structure' }}
                    </Link>
                </Button>
                ...
                <Dialog v-if="rubric.status === 'locked'" v-model:open="showReplaceDialog">
                    ...
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>Upload New Rubric PDF?</DialogTitle>
                            <DialogDescription>
                                This keeps the current rubric record but replaces the locked PDF and extracted criteria with a new upload. You must verify and lock the new rubric again before reviewers use it.
                            </DialogDescription>
                        </DialogHeader>
                        <div class="flex items-start gap-2 rounded-lg bg-amber-50 px-4 py-3 text-sm text-amber-700 dark:bg-amber-950 dark:text-amber-300">
                            ...
                            Use this only when you want a fresh official rubric PDF instead of correcting the locked criteria manually.
                        </div>
                        <DialogFooter>
                ...
                <Dialog v-if="rubric.status !== 'locked'" v-model:open="showRemoveDialog">
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                This will delete the current rubric PDF and extracted structure. You will need to upload a new rubric file.
                            </DialogDescription>
                        </DialogHeader>
                        <DialogFooter>
                            <DialogClose as-child>
                ...
                <Dialog v-if="rubric.status === 'pending_verification'" v-model:open="showApproveDialog">
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Once locked, the rubric structure cannot be edited. Reviewers will use these criteria to score papers. Make sure the criteria and weights are correct.
                            </DialogDescription>
                        </DialogHeader>
