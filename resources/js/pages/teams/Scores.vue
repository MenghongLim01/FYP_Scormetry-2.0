...
import { formatClockTime, formatDateTimeWithAmPm } from '@/lib/utils';
...
<template>
    ...
    <div class="flex flex-col">
            ...
            <Card class="rounded-2xl border-blue-100 shadow-md dark:border-blue-900">
                <CardContent class="flex items-center gap-3 p-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-muted-foreground">{{ team.defense_time ? formatClockTime(team.defense_time) : '' }} {{ team.defense_room ? `· ${team.defense_room}` : '' }}</p>
                    </div>
                </CardContent>
            </Card>
            <Card class="rounded-2xl border-indigo-100 shadow-md dark:border-indigo-900">
                <CardContent class="flex items-center gap-3 p-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-muted-foreground">Scoring roles submitted</p>
                    </div>
                </CardContent>
            </Card>
        ...
        <!-- Outstanding scoring roles warning -->
