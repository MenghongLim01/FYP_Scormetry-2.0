...
import { index as subjectsIndex, store as subjectStore } from '@/actions/App/Http/Controllers/SubjectController';
            ...
            <CardHeader>
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <CardDescription>Set up a new subject for your students</CardDescription>
                    </div>
                </div>
            </CardHeader>
            <CardContent>
                <form @submit.prevent="submit" class="flex flex-col gap-5">
                    <div class="flex flex-col gap-1.5">
                        ...
                        <Input id="title" v-model="form.title" type="text" placeholder="e.g., Mathematics 101" required />
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <p class="text-xs text-muted-foreground">Minimum score required to mark a document review as completed.</p>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-xs text-muted-foreground">
                                    When enabled, students and reviewers who join via code will be placed in a pending state until you approve them.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="flex justify-end gap-3 pt-2">
                        <Button variant="outline" as-child>
                            <Link :href="subjectsIndex.url()">Cancel</Link>
                        </Button>
