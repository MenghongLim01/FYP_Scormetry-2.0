...
class DefenseScheduledMail extends Mailable
{
    ...
    /**
     * @param  array{defense_date?: string|null, defense_time?: string|null, defense_duration?: int|null, defense_room?: string|null, paper_upload_deadline_at?: string|null, score_deadline_at?: string|null}|null  $calendarSchedule
     */
    ...
    public function content(): Content
    {
        return new Content(
            ...
            with: [
                ...
                'endsAt' => $this->endsAt(),
                'paperUploadDeadlineAt' => $this->paperUploadDeadlineAt(),
    ...
    private function paperUploadDeadlineAt(): ?Carbon
    {
        $value = $this->scheduleValue('paper_upload_deadline_at');
